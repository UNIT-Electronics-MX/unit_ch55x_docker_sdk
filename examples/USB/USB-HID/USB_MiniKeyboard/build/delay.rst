      ...
      000196                        569 _DLY_us:
                           ...
                           000001   576 	ar1 = 0x01
                           000000   577 	ar0 = 0x00
      000196 AE 82            [24]  578 	mov	r6,dpl
      000198 AF 83            [24]  579 	mov	r7,dph
                                    580 ;	src/delay.c:24: while(n) {                        // total = 12~13 Fsys cycles, 1uS @Fsys=12MHz
      00019A                        581 00101$:
      00019A EE               [12]  582 	mov	a,r6
      00019B 4F               [12]  583 	orl	a,r7
      00019C 60 16            [24]  584 	jz	00104$
                                    585 ;	src/delay.c:25: SAFE_MOD++;                     // 2 Fsys cycles, for higher Fsys, add operation here
      00019E E5 A1            [12]  586 	mov	a,_SAFE_MOD
      0001A0 04               [12]  587 	inc	a
      0001A1 F5 A1            [12]  588 	mov	_SAFE_MOD,a
                                    589 ;	src/delay.c:28: SAFE_MOD++;
      0001A3 E5 A1            [12]  590 	mov	a,_SAFE_MOD
      0001A5 04               [12]  591 	inc	a
      0001A6 F5 A1            [12]  592 	mov	_SAFE_MOD,a
                                    593 ;	src/delay.c:31: SAFE_MOD++;
      0001A8 E5 A1            [12]  594 	mov	a,_SAFE_MOD
      0001AA 04               [12]  595 	inc	a
      0001AB F5 A1            [12]  596 	mov	_SAFE_MOD,a
                                    597 ;	src/delay.c:58: n--;
      0001AD 1E               [12]  598 	dec	r6
      0001AE BE FF 01         [24]  599 	cjne	r6,#0xff,00116$
      0001B1 1F               [12]  600 	dec	r7
      0001B2                        601 00116$:
      0001B2 80 E6            [24]  602 	sjmp	00101$
      0001B4                        603 00104$:
                                    604 ;	src/delay.c:60: }
      0001B4 22               [24]  605 	ret
                                    606 ;------------------------------------------------------------
                                    ...
                                    614 ;	-----------------------------------------
      0001B5                        615 _DLY_ms:
      0001B5 AE 82            [24]  616 	mov	r6,dpl
      0001B7 AF 83            [24]  617 	mov	r7,dph
                                    618 ;	src/delay.c:66: while(n) {
      0001B9                        619 00101$:
      0001B9 EE               [12]  620 	mov	a,r6
      0001BA 4F               [12]  621 	orl	a,r7
      0001BB 60 15            [24]  622 	jz	00104$
                                    623 ;	src/delay.c:67: DLY_us(1000);
      0001BD 90 03 E8         [24]  624 	mov	dptr,#0x03e8
      0001C0 C0 07            [24]  625 	push	ar7
      0001C2 C0 06            [24]  626 	push	ar6
      0001C4 12 01 96         [24]  627 	lcall	_DLY_us
      0001C7 D0 06            [24]  628 	pop	ar6
      0001C9 D0 07            [24]  629 	pop	ar7
                                    630 ;	src/delay.c:68: n--;
      0001CB 1E               [12]  631 	dec	r6
      0001CC BE FF 01         [24]  632 	cjne	r6,#0xff,00116$
      0001CF 1F               [12]  633 	dec	r7
      0001D0                        634 00116$:
      0001D0 80 E7            [24]  635 	sjmp	00101$
      0001D2                        636 00104$:
                                    637 ;	src/delay.c:70: }
      0001D2 22               [24]  638 	ret
                                    639 ;------------------------------------------------------------
                                    ...
                                    647 ;	-----------------------------------------
      0001D3                        648 __delay_more_cycles:
                                    649 ;	naked function: no prologue.
                                    650 ;	src/delay.c:85: __endasm;
      0001D4                        651 	.even	; make predictable cycles for jumps
      0001D4 C0 07            [24]  652 	push	ar7 ; 2 cycles
      0001D6 AF 82            [24]  653 	mov	r7, dpl ; 2 cycles
      0001D8 DF FE            [24]  654 	djnz	r7, .+0 ; 2/4 cycles
      0001DA D0 07            [24]  655 	pop	ar7 ; 2 cycles
      0001DC 22               [24]  656 	ret	; 4|5 cycles
                                    657 ;	src/delay.c:86: }
