...
;	src/usb_handler.c:158: switch(USB_setupBuf->wIndexL) {
	...
	sjmp	00136$
00356$:
;	src/usb_handler.c:185: case 0x02:
	cjne	r6,#0x81,00138$
	sjmp	00137$
00136$:
;	src/usb_handler.c:186: UEP2_CTRL = UEP2_CTRL & ~ ( bUEP_R_TOG | MASK_UEP_R_RES ) | UEP_R_RES_ACK;
	anl	_UEP2_CTRL,#0x73
;	src/usb_handler.c:187: break;
	ljmp	00176$
;	src/usb_handler.c:190: case 0x81:
00137$:
...
;	src/usb_handler.c:216: switch( ( (uint16_t)USB_setupBuf->wIndexH << 8 ) | USB_setupBuf->wIndexL ) {
	...
	sjmp	00152$
00366$:
;	src/usb_handler.c:243: case 0x02:
	cjne	r6,#0x81,00154$
	cjne	r5,#0x00,00154$
	sjmp	00153$
00152$:
;	src/usb_handler.c:244: UEP2_CTRL = UEP2_CTRL & (~bUEP_R_TOG) | UEP_R_RES_STALL;// Set EP2 OUT Stall 
	mov	a,#0x7f
	anl	a,_UEP2_CTRL
	orl	a,#0x0c
	mov	_UEP2_CTRL,a
;	src/usb_handler.c:245: break;
;	src/usb_handler.c:248: case 0x81:
	sjmp	00176$
00153$:
...
00102$:
	lcall	_USB_EP0_OUT
;	src/usb_handler.c:344: case 2: EP2_OUT_callback(); break;
	sjmp	00118$
00103$:
	lcall	_HID_EP2_OUT
