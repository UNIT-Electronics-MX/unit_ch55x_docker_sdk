      ...
      000000                        531 	.ds 8
                                    ...
                                    534 ;--------------------------------------------------------
                                    535 	.area DSEG    (DATA)
      000008                        536 _NEO_writeColor_PARM_2:
      000008                        537 	.ds 1
      000009                        538 _NEO_writeColor_PARM_3:
      000009                        539 	.ds 1
      00000A                        540 _NEO_writeHue_PARM_2:
      00000A                        541 	.ds 1
                                    542 ;--------------------------------------------------------
      ...
      0001DD                        619 	.even
      0001DD 7F 08            [12]  620 	mov	r7, #8 ; 2 CLK - 8 bits to transfer
      0001DF C5 82            [12]  621 	xch	a, dpl ; 2 CLK - data byte -> accu
      0001E1                        622 	    01$:
      0001E1 33               [12]  623 	rlc	a ; 1 CLK - data bit -> carry (MSB first)
      0001E2 D2 B3            [12]  624 	setb	_PP33 ; 2 CLK - NEO pin HIGH
      0001E4 92 B3            [24]  625 	mov	_PP33, c ; 2 CLK - "0"-bit? -> NEO pin LOW now
      0001E6 00               [12]  626 	nop	
      0001E7 00               [12]  627 	nop 
      0001E8 00               [12]  628 	nop 
      0001E9 00               [12]  629 	nop 
      0001EA 00               [12]  630 	nop 
      0001EB 00               [12]  631 	nop ; x CLK - TH1 delay
      0001EC C2 B3            [12]  632 	clr	_PP33 ; 2 CLK - "1"-bit? -> NEO pin LOW a little later
      0001EE 00               [12]  633 	nop	
      0001EF 00               [12]  634 	nop ; y CLK - TCT delay
      0001F0 DF EF            [24]  635 	djnz	r7, 01$ ; 2/4|5|6 CLK - repeat for all bits
                                    636 ;	src/neo.c:97: }
      0001F2 22               [24]  637 	ret
                                    638 ;------------------------------------------------------------
                                    ...
                                    648 ;	-----------------------------------------
      0001F3                        649 _NEO_writeColor:
      0001F3 AF 82            [24]  650 	mov	r7,dpl
                                    651 ;	src/neo.c:104: NEO_sendByte(g); NEO_sendByte(r); NEO_sendByte(b);
      0001F5 85 08 82         [24]  652 	mov	dpl,_NEO_writeColor_PARM_2
      0001F8 C0 07            [24]  653 	push	ar7
      0001FA 12 01 DD         [24]  654 	lcall	_NEO_sendByte
      0001FD D0 07            [24]  655 	pop	ar7
      0001FF 8F 82            [24]  656 	mov	dpl,r7
      000201 12 01 DD         [24]  657 	lcall	_NEO_sendByte
      000204 85 09 82         [24]  658 	mov	dpl,_NEO_writeColor_PARM_3
                                    659 ;	src/neo.c:110: }
      000207 02 01 DD         [24]  660 	ljmp	_NEO_sendByte
                                    661 ;------------------------------------------------------------
                                    ...
                                    673 ;	-----------------------------------------
      00020A                        674 _NEO_writeHue:
                                    675 ;	src/neo.c:116: uint8_t phase = hue >> 6;
      00020A E5 82            [12]  676 	mov	a,dpl
      00020C FF               [12]  677 	mov	r7,a
      00020D 23               [12]  678 	rl	a
      00020E 23               [12]  679 	rl	a
      00020F 54 03            [12]  680 	anl	a,#0x03
      000211 FE               [12]  681 	mov	r6,a
                                    682 ;	src/neo.c:117: uint8_t step  = (hue & 63) << bright;
      000212 53 07 3F         [24]  683 	anl	ar7,#0x3f
      000215 AD 0A            [24]  684 	mov	r5,_NEO_writeHue_PARM_2
      000217 8D F0            [24]  685 	mov	b,r5
      000219 05 F0            [12]  686 	inc	b
      00021B EF               [12]  687 	mov	a,r7
      00021C 80 02            [24]  688 	sjmp	00122$
      00021E                        689 00120$:
      00021E 25 E0            [12]  690 	add	a,acc
      000220                        691 00122$:
      000220 D5 F0 FB         [24]  692 	djnz	b,00120$
      000223 FF               [12]  693 	mov	r7,a
                                    694 ;	src/neo.c:118: uint8_t nstep = (63 << bright) - step;
      000224 8D F0            [24]  695 	mov	b,r5
      000226 05 F0            [12]  696 	inc	b
      000228 74 3F            [12]  697 	mov	a,#0x3f
      00022A 80 02            [24]  698 	sjmp	00125$
      00022C                        699 00123$:
      00022C 25 E0            [12]  700 	add	a,acc
      00022E                        701 00125$:
      00022E D5 F0 FB         [24]  702 	djnz	b,00123$
      000231 8F 04            [24]  703 	mov	ar4,r7
      000233 C3               [12]  704 	clr	c
      000234 9C               [12]  705 	subb	a,r4
      000235 FD               [12]  706 	mov	r5,a
                                    707 ;	src/neo.c:119: switch(phase) {
      000236 BE 00 02         [24]  708 	cjne	r6,#0x00,00126$
      000239 80 0A            [24]  709 	sjmp	00101$
      00023B                        710 00126$:
      00023B BE 01 02         [24]  711 	cjne	r6,#0x01,00127$
      00023E 80 0F            [24]  712 	sjmp	00102$
      000240                        713 00127$:
                                    714 ;	src/neo.c:120: case 0:   NEO_writeColor(nstep,  step,     0); break;
      000240 BE 02 20         [24]  715 	cjne	r6,#0x02,00106$
      000243 80 14            [24]  716 	sjmp	00103$
      000245                        717 00101$:
      000245 8F 08            [24]  718 	mov	_NEO_writeColor_PARM_2,r7
      000247 75 09 00         [24]  719 	mov	_NEO_writeColor_PARM_3,#0x00
      00024A 8D 82            [24]  720 	mov	dpl,r5
                                    721 ;	src/neo.c:121: case 1:   NEO_writeColor(    0, nstep,  step); break;
      00024C 02 01 F3         [24]  722 	ljmp	_NEO_writeColor
      00024F                        723 00102$:
      00024F 8D 08            [24]  724 	mov	_NEO_writeColor_PARM_2,r5
      000251 8F 09            [24]  725 	mov	_NEO_writeColor_PARM_3,r7
      000253 75 82 00         [24]  726 	mov	dpl,#0x00
                                    727 ;	src/neo.c:122: case 2:   NEO_writeColor( step,     0, nstep); break;
      000256 02 01 F3         [24]  728 	ljmp	_NEO_writeColor
      000259                        729 00103$:
      000259 75 08 00         [24]  730 	mov	_NEO_writeColor_PARM_2,#0x00
      00025C 8D 09            [24]  731 	mov	_NEO_writeColor_PARM_3,r5
      00025E 8F 82            [24]  732 	mov	dpl,r7
                                    733 ;	src/neo.c:124: }
                                    734 ;	src/neo.c:125: }
      000260 02 01 F3         [24]  735 	ljmp	_NEO_writeColor
      000263                        736 00106$:
      000263 22               [24]  737 	ret
                                    738 	.area CSEG    (CODE)
                                    739 	.area CONST   (CODE)
